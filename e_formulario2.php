...
?>
	<div class="grid_16 blanco">
        ...
        <h1 class="grid_15 prefix_1 rojo alpha" style="color:#FFF;font-size:20px;text-shadow: 1px 1px 4px #000000;">Eliminar Muestra</h1>
        	<div class="clear"></div>
            	<br />
                <br />
                <?php
               ...
               <button class="rojo" style="color:#FFFFFF; padding:2px; font-weight:bold;" name="accion" id="eliminar_m" type="submit" value="eliminar_m">Eliminar</button>
                <br />
                <br />
                </div>
               </form>
