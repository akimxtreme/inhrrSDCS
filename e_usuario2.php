...
?>
	<div class="grid_16 blanco">
        ...
        <h1 class="grid_15 prefix_1 rojo alpha" style="color:#FFF;font-size:20px;text-shadow: 1px 1px 4px #000000;">Eliminar Usuario</h1>
        	<div class="clear"></div>
            	<br />
                <br />
                <?php
               ...
               <form class="grid_16" method="post" action="bd_acciones.php">
               <div class="grid_2 alpha prefix_14">
               <input type="hidden" name="codigo" value="<?php echo $campo4  ?>" />
               <button class="rojo" style="color:#FFFFFF; padding:2px; font-weight:bold;" name="accion" type="submit" value="e_usuario">Eliminar</button>
                <br />
                <br />
                </div>
               </form>
