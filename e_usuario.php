...
<?php menu("formulario.php","#"); ?>
	...
	$i=0;
					...
					echo '<td class="grid_2 blanco alpha omega"><a class="rojo grid_2 alpha omega" style="margin:-10px 0px -10px 0px; color:#FFF; text-shadow: 0px 0px 2px #000;" href="e_usuario2.php?usuario=' .$campo1 . '">Eliminar &raquo;</a></td> ';
					}
	?>
    </table>
    </div>
