...
<?php menu("formulario.php","#"); ?>
	...
	$i=0;
					...
					echo '<td class="grid_2 blanco alpha omega"><a class="azul3 grid_2 alpha omega" style="margin:-10px 0px -10px 0px; color:#FFF; text-shadow: 0px 0px 2px #000;" href="m_formulario2.php?muestra=' .$campo1 . '">Ver &raquo;</a></td> ';
					}
	?>
    </table>
    </div>
